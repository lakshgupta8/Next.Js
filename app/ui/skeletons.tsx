...
export function InvoiceSkeleton() {
  return (
    <div className="flex flex-row justify-between items-center py-4 border-gray-100 border-b">
...
export function TableRowSkeleton() {
  return (
    <tr className="border-gray-100 border-b last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg w-full">
      {/* Customer Name and Image */}
      <td className="relative py-3 pr-3 pl-6 overflow-hidden whitespace-nowrap">
...
export function InvoicesMobileSkeleton() {
  return (
    <div className="bg-white mb-2 p-4 rounded-md w-full">
      <div className="flex justify-between items-center pb-8 border-gray-100 border-b">
        <div className="flex items-center">
